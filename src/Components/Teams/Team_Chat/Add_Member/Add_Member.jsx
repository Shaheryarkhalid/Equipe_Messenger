...
function Add_Member({set_Add_Member_Toogle, Opened_Team}) {
    ...
    let [Team_Members,set_Team_Members]=useState(Opened_Team.Members);
	...
	useEffect(()=>{
        firestore.collection("Teams").where("TID","==",Opened_Team.TID).onSnapshot((Snap)=>{
            set_Team_Members(Snap.docs[0].data().Members);
        })
    },[])
    ...
    function HandleTeamSubmit(e)
    {
        ...
        firestore.collection("Teams").where("TID","==",Opened_Team.TID).get().then((Snap)=>{
            Snap.docs[0].ref.update({
                Members:Team_Members
            });
            set_Adding_Team(false);
            set_Add_Member_Toogle(false);
        })
    }
  return (
            ...
            <div className="relative p-4 w-full max-h-full flex items-center justify-center ">
                <div className="relative bg-gray-900 rounded-md">
                    <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        ...
                        <button
                            onClick={()=>set_Add_Member_Toogle(false)}
                    ...
                    <form className="p-4 md:p-5" onSubmit={HandleTeamSubmit} action="#">
                        <div className="grid gap-4 mb-4 grid-cols-2">
                            ...
                            <div className="col-span-2 sm:col-span-1 relative">
                                <label htmlFor="category" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Team Members</label>
                            ...
                            <button disabled={Adding_Team}  type="submit" className=" max-h-10 self-end text-white inline-flex disabled:cursor-not-allowed items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                {
                                    Adding_Team ? 
...
Add_Member.propTypes={
    set_Add_Member_Toogle:PropTypes.func,
