                        ...
                        <form className="p-4 md:p-5" onSubmit={HandleTeamSubmit} action="#">
                            <div className="grid gap-4 mb-4 grid-cols-2">
                                ...
                                <div className="col-span-2 sm:col-span-1">
                                    <label htmlFor="Objective" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Objective</label>
                                    <input type="text" name="Objective"
                                            ...
                                            id="Objective" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Team's Objective" required="" />
                                </div>
                                <div className="col-span-2 sm:col-span-1 relative">
                                    <label htmlFor="category" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Add Team Members</label>
                                    
                                    <button id="dropdownSearchButton" 
                                            onClick={()=>set_Select_Team(!Select_Team)}
                                            data-dropdown-toggle="dropdownSearch" data-dropdown-placement="bottom" className="text-white  focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" type="button"> Select Team Members
                                                            ...
                                                            return(
                                                                <>
                                                                    <li className=" cursor-pointer">
                                                                        <div className="flex items-center ps-2 py-1 rounded hover:bg-gray-100 dark:hover:bg-gray-600 cursor-pointer">
                                                                            <input  id={usr.UID}
                                                                            ...
                                                                            <label htmlFor={usr.UID} className="w-full py-2 ms-2 text-sm font-medium text-gray-900 rounded dark:text-gray-300 cursor-pointer">
                                                                                {usr.Name}
                                                                            </label>
                                                                        </div>
                                                                    </li>
							...
							<button disabled={Adding_Team}  type="submit" className="text-white inline-flex disabled:cursor-not-allowed items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
								{
									Adding_Team ? 
