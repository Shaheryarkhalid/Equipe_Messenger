...
function Shared_Files({message}) {
  ...
  return (
    <div className="w-full flex mt-4 justify-center gap-2 relative left-0">
        <div className="  h-full min-w-[170px] max-w-[170px]  text-wrap leading-1.5 p-2 rounded-se-xl rounded-s-xl bg-slate-900 flex flex-col items-center">
            
            <div className="text-sm overflow-hidden font-semibold min-w-[150px] max-w-[150px] text-wrap py-2.5 text-gray-100 " style={{ overflowWrap: 'break-word' }}>
				{ message && message.Message.Type ? 
					<>
						{!(message.Message.Type === "png" ||
							...
							<div className=" w-full h-full flex flex-col items-start my-2.5 bg-gray-600 rounded-xl px-2">
							...
							<div className="grid gap-4 grid-cols- my-2.5">
								<div className="group relative">
									<div className="absolute z-10 top-2 left-3 bg-gray-900/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-full flex items-center justify-center">
										{    !File_Downloading ?
												<button 
													onClick={()=>Handle_File_Download(message.Message)}
