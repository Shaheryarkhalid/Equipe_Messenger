                ...
                <>
                    <div onClick={()=>set_Opened_Team(team)}  className={(team && Opened_Team && team.TID === Opened_Team.TID ? " bg-slate-600 "  : "" ) + " relative w-full mt-2 flex items-center gap-4 py-2 px-4 border-b border-slate-300 cursor-pointer hover:bg-slate-700 rounded-t-lg"}>
                        ...
                        <div className=" relative">
                            <h6 className=" max-w-[130px] truncate block font-sans text-left text-gray-200 antialiased font-semibold leading-relaxed tracking-normal ">
                                {team.Name}
                            </h6>
                            <p className="  max-w-[130px] truncate  block font-sans text-left text-sm antialiased font-normal leading-normal text-gray-400">
                                {team.Objective}
                            </p>
                        </div>
